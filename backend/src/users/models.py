...
class EmployeeCategory(models.Model):
	cat_name = models.CharField(max_length=155, unique=True)
...
class UserProfile(models.Model):
	...
	reader_uid = models.CharField(max_length=155, default=dummy_unique_str, unique=True)
...
class Department(models.Model):
	dept_name = models.CharField(max_length=155, unique=True)
...
class EmployeeStatus(models.Model):
	status = models.CharField(max_length=155, unique=True)
	description = models.CharField(max_length=255, blank=True, null=True)
